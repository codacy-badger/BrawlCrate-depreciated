	...
	public partial class MainForm : Form {
		...
		private void addmissingPAT0EntriesToolStripMenuItem_Click(object sender, EventArgs e) {
			...
			if (dialog.ShowDialog(this) == DialogResult.OK) {
				...
				portraitViewer1.AddPAT0("Misc Data [80]/AnmTexPat(NW4R)/MenSelmapPreview/pasted__stnameshadowM", dialog.AddNewTextures);
				portraitViewer1.AddPAT0("Misc Data [80]/AnmTexPat(NW4R)/MenSelmapPreview/pasted__stnamelogoM", dialog.AddNewTextures,
					dialog.UseSameSelmapMarksForAll ? "MenSelmapMark.01" : null);
				portraitViewer1.AddPAT0("Misc Data [80]/AnmTexPat(NW4R)/MenSelmapPreview/pasted__stnameM", dialog.AddNewTextures);
				portraitViewer1.AddPAT0("Misc Data [80]/AnmTexPat(NW4R)/MenSelmapPreview/lambert113", dialog.AddNewTextures,
					dialog.UseSameSelchrMarksForAll ? "MenSelchrMark.20" : null);
				portraitViewer1.AddPAT0("Misc Data [80]/AnmTexPat(NW4R)/MenSelmapPreview/basebgM", dialog.AddNewTextures);
