...
namespace BrawlStageManager {
	public static class SongsByStageID {
		...
		private static Dictionary<int, string[]> dict = new Dictionary<int, string[]>() {
			...
			{2, new string[] { // Final Destination
				("X05"),
				("T01"),
				("T03"),
				("W25"),
			...
			{5, new string[] { // Mushroomy Kingdom
				("A01"),
				("A16"),
				("A10"),
				("A02"),
			...
			{13, new string[] { // Yoshi's Island (Brawl)
				("E02"),
				("E07"),
				("E01"),
				("E03"),
			...
			{20, new string[] { // Pokemon Stadium 2
				("H01"),
				("H03"),
				("H02"),
				("H04"),
			...
			{22, new string[] { // Port Town Aero Dive
				("I01"),
				("I03"),
				("I02"),
				("I04"),
			...
			{24, new string[] { // Flat Zone 2
				("R04"),
				("Q04"),
				("W14"),
			}},
			{36, new string[] { // PictoChat
				("R02"),
				("R10"),
				("R11"),
				("R15"),
			...
			{37, new string[] { // Hanenbow
				("R03"),
			}},
			{34, new string[] { // Shadow Moses Island
				("S06"),
				("S02"),
				("S03"),
				("S08"),
			...
			{41, new string[] { // Temple
				("C03"),
				("W24"),
			}},
			{42, new string[] { // Yoshi's Island (Melee)
				("W05"),
				("W15"),
			}},
			{43, new string[] { // Jungle Japes
				("W03"),
				("W26"),
			}},
			{44, new string[] { // Onett
			...
			{48, new string[] { // Corneria
				("W08"),
				("W28"),
			}},
			{47, new string[] { // Rainbow Cruise
				("W02"),
				("W01"),
			}},
			{45, new string[] { // Green Greens
				("W07"),
				("W06"),
			}},
			{49, new string[] { // Big Blue
				("W11"),
				("W29"),
			}},
			{50, new string[] { // Brinstar
				("W27"),
				("W04"),
			}},
			{46, new string[] { // Pokemon Stadium
				("W09"),
				("W16"),
				("W10"),
			}},
			{55, new string[] { // Online Training
				("X07"),
			}},
		};
        #endregion
