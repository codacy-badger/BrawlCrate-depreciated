...
namespace BrawlCrate.NodeWrappers
{
    ...
    internal class CHR0Wrapper : GenericWrapper
    {
        ...
        protected static void KeyframeGenAction(object sender, EventArgs e)
        {
            GetInstance<CHR0Wrapper>().KeyFrameGen(2, false, false);
        }
    ...
    internal class CHR0EntryWrapper : GenericWrapper
    {
        ...
        static CHR0EntryWrapper()
        {
            ...
            _menu.Items.Add(new ToolStripMenuItem("Re&name", null, RenameAction, Keys.Control | Keys.N));
            _menu.Items.Add(new ToolStripSeparator());
            _menu.Items.Add(new ToolStripMenuItem("Generate Keyframe From Bone Position", null,
                KeyframeGenFromBoneAction));
            _menu.Items.Add(new ToolStripSeparator());
            _menu.Items.Add(new ToolStripMenuItem("&Delete", null, DeleteAction, Keys.Control | Keys.Delete));
            _menu.Opening += MenuOpening;
            _menu.Closing += MenuClosing;
        ...
        protected static void KeyframeGenFromBoneAction(object sender, EventArgs e)
        {
            GetInstance<CHR0EntryWrapper>().KeyFrameGenFromBone(2, true, true);
        }
