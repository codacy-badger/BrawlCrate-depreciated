...
namespace BrawlCrate
{
    ...
    class CLR0Wrapper : GenericWrapper
    {
        ...
        static CLR0Wrapper()
        {
            ...
            _menu.Items.Add(new ToolStripMenuItem(BrawlLib.Properties.Resources.NewMaterialEntry, null, NewCLRAction));
            _menu.Items.Add(new ToolStripSeparator());
            _menu.Items.Add(new ToolStripMenuItem(BrawlLib.Properties.Resources.SortEntries, null, SortAction));
            _menu.Items.Add(new ToolStripSeparator());
    ...
    class CLR0MaterialWrapper : GenericWrapper
    {
        ...
        {
            _menu = new ContextMenuStrip();
            _menu.Items.Add(new ToolStripMenuItem(BrawlLib.Properties.Resources.NewColorSequence, null, NewCLRAction));
            _menu.Items.Add(new ToolStripSeparator());
            _menu.Items.Add(new ToolStripMenuItem(BrawlLib.Properties.Resources.Export, null, ExportAction, Keys.Control | Keys.E));
            _menu.Items.Add(new ToolStripMenuItem(BrawlLib.Properties.Resources.Replace, null, ReplaceAction, Keys.Control | Keys.R));
            _menu.Items.Add(new ToolStripMenuItem(BrawlLib.Properties.Resources.Restore, null, RestoreAction, Keys.Control | Keys.T));
