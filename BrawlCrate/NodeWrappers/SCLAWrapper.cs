...
namespace BrawlCrate.NodeWrappers
{
    ...
    internal class SCLAWrapper : GenericWrapper
    {
        ...
        static SCLAWrapper()
        {
            ...
            _menu.Items.Add(new ToolStripMenuItem("Fill (Expanded)", null, FillExpandedAction,
                Keys.Control | Keys.Alt | Keys.F));
        ...
        protected static void FillExpandedAction(object sender, EventArgs e)
        {
            GetInstance<SCLAWrapper>().FillSCLA(256);
        }
        ...
        public override ResourceNode Duplicate()
        {
            ...
            _resource.Rebuild();
            SCLANode newNode = NodeFactory.FromAddress(null, _resource.WorkingUncompressed.Address,
                _resource.WorkingUncompressed.Length) as SCLANode;
