...
namespace BrawlCrate.NodeWrappers
{
    ...
    internal class RSARGroupWrapper : GenericWrapper
    {
        ...
        protected static void ExportSawndzAction(object sender, EventArgs e)
        {
            GetInstance<RSARGroupWrapper>().ExportSawndz();
        }
        ...
        private static void MenuOpening(object sender, CancelEventArgs e)
        {
            ...
            _menu.Items[0].Enabled = _menu.Items[0].Visible = _menu.Items[1].Visible =
                File.Exists(AppDomain.CurrentDomain.BaseDirectory + '\\' + "sawndz.exe");
        ...
        public void ExportSawndz()
        {
            ...
            if (index != 0)
            {
                ...
                if (stuffChanged && MainForm.Instance.RootNode != null &&
                    MainForm.Instance.RootNode.ResourceNode != null)
                {
