...
namespace BrawlCrate.NodeWrappers
{
    ...
    internal class SCN0Wrapper : GenericWrapper
    {
        #region Menu
    ...
    internal class SCN0CameraWrapper : GenericWrapper
    {
        #region Menu
    ...
    internal class SCN0FogWrapper : GenericWrapper
    {
        #region Menu
    ...
    internal class SCN0LightWrapper : GenericWrapper
    {
        #region Menu
