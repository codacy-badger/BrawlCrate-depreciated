...
namespace BrawlCrate.NodeWrappers
{
    ...
    internal class TBGDWrapper : STDTWrapper
    {
        ...
        public override ResourceNode Duplicate()
        {
            ...
            _resource.Rebuild();
            TBGDNode newNode = NodeFactory.FromAddress(null, _resource.WorkingUncompressed.Address,
                _resource.WorkingUncompressed.Length) as TBGDNode;
