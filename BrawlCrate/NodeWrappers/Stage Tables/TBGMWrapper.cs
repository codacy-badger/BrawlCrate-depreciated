...
namespace BrawlCrate.NodeWrappers
{
    ...
    internal class TBGMWrapper : STDTWrapper
    {
        ...
        public override ResourceNode Duplicate()
        {
            ...
            _resource.Rebuild();
            TBGMNode newNode = NodeFactory.FromAddress(null, _resource.WorkingUncompressed.Address,
                _resource.WorkingUncompressed.Length) as TBGMNode;
