...
namespace BrawlCrate.NodeWrappers
{
    ...
    internal class TBLVWrapper : STDTWrapper
    {
        ...
        public override ResourceNode Duplicate()
        {
            ...
            _resource.Rebuild();
            TBLVNode newNode = NodeFactory.FromAddress(null, _resource.WorkingUncompressed.Address,
                _resource.WorkingUncompressed.Length) as TBLVNode;
