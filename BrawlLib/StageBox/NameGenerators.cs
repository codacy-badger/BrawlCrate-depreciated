...
namespace BrawlLib.StageBox
{
    public class FighterNameGenerators
    {
        ...
        {
            foreach (string s in nameList)
                if (s.ToLower().Substring(8).StartsWith(pacName.ToLower()))
                    return s.Substring(24);
            return pacName.ToLower();
        }

        public static void GenerateDefaultList()
        {
            string listDefault = "SlotID |Original Name  | Actual Name\nDON'T EDIT THESE TWO   |EDIT THIS\n----------------------------------------------------\n0x00   |mario          |Mario\n0x01   |donkey         |Donkey Kong\n0x02   |link           |Link\n0x03   |samus          |Samus\n0x04   |szerosuit      |Zero Suit Samus\n0x05   |yoshi          |Yoshi\n0x06   |kirby          |Kirby\n0x07   |fox            |Fox\n0x08   |pikachu        |Pikachu\n0x09   |luigi          |Luigi\n0x0A   |captain        |Captain Falcon\n0x0B   |ness           |Ness\n0x0C   |bowser         |Bowser\n0x0D   |peach          |Peach\n0x0E   |zelda          |Zelda\n0x0F   |sheik          |Sheik\n0x10   |iceclimber     |Ice Climbers\n0x11   |popo           |Popo\n0x12   |nana           |Nana\n0x13   |marth          |Marth\n0x14   |gamewatch      |Mr. Game & Watch\n0x15   |falco          |Falco\n0x16   |ganon          |Ganondorf\n0x17   |wario          |Wario\n0x18   |metaknight     |Meta Knight\n0x19   |pit            |Pit\n0x1A   |pikmin         |Olimar & Pikmin\n0x1B   |lucas          |Lucas\n0x1C   |diddy          |Diddy Kong\nN/A    |poketrainer    |Pokémon Trainer\n0x1D   |pokelizardon   |Charizard (Pokémon Trainer)\n0x1E   |lizardon       |Charizard (Independent)\n0x1F   |pokezenigame   |Squirtle (Pokémon Trainer)\n0x20   |zenigame       |Squirtle (Independent)\n0x21   |pokefushigisou |Ivysaur (Pokémon Trainer)\n0x22   |fushigisou     |Ivysaur (Independent)\n0x23   |dedede         |King Dedede\n0x24   |lucario        |Lucario\n0x25   |ike            |Ike\n0x26   |robot          |R.O.B.\n0x27   |purin          |Jigglypuff\n0x28   |toonlink       |Toon Link\n0x29   |wolf           |Wolf\n0x2A   |snake          |Snake\n0x2B   |sonic          |Sonic\n0x2C   |gkoopa         |Giga Bowser\n0x2D   |warioman       |Wario-Man\n0x2E   |zakoboy        |Red Alloy (Don't use in event matches)\n0x2F   |zakogirl       |Blue Alloy (Don't use in event matches)\n0x30   |zakochild      |Yellow Alloy (Don't use in event matches)\n0x31   |zakoball       |Green Alloy (Don't use in event matches)\n0x32   |roy            |Roy (Project M Only)\n0x33   |mewtwo         |Mewtwo (Project M Only)\n0x34   |rayquaza       |Rayquaza (unused)\n0x35   |porkystatue    |Porky Statue (unused)\n0x36   |porky          |Porky Robot (unused)\n0x37   |headrobo       |Galleom (unused)\n0x38   |ridley         |Ridley (unused)\n0x39   |duon           |Duon (unused)\n0x3A   |metaridley     |Meta-Ridley (unused)\n0x3B   |taboo          |Taboo (unused)\n0x3C   |masterhand     |Master Hand (unused)\n0x3D   |crazyhand      |Crazy Hand (unused)\n0x3E   |none           |None (unused)\n0x3F   |exfighter3f    |ExFighter0x3F\n0x40   |exfighter40    |ExFighter0x40\n0x41   |exfighter41    |ExFighter0x41\n0x42   |exfighter42    |ExFighter0x42\n0x43   |exfighter43    |ExFighter0x43\n0x44   |exfighter44    |ExFighter0x44\n0x45   |exfighter45    |ExFighter0x45\n0x46   |exfighter46    |ExFighter0x46\n0x47   |exfighter47    |ExFighter0x47\n0x48   |exfighter48    |ExFighter0x48\n0x49   |exfighter49    |ExFighter0x49\n0x4A   |exfighter4a    |ExFighter0x4A\n0x4B   |exfighter4b    |ExFighter0x4B\n0x4C   |exfighter4c    |ExFighter0x4C\n0x4D   |exfighter4d    |ExFighter0x4D\n0x4E   |exfighter4e    |ExFighter0x4E\n0x4F   |exfighter4f    |ExFighter0x4F\n0x50   |exfighter50    |ExFighter0x50\n0x51   |exfighter51    |ExFighter0x51\n0x52   |exfighter52    |ExFighter0x52\n0x53   |exfighter53    |ExFighter0x53\n0x54   |exfighter54    |ExFighter0x54\n0x55   |exfighter55    |ExFighter0x55\n0x56   |exfighter56    |ExFighter0x56\n0x57   |exfighter57    |ExFighter0x57\n0x58   |exfighter58    |ExFighter0x58\n0x59   |exfighter59    |ExFighter0x59\n0x5A   |exfighter5a    |ExFighter0x5A\n0x5B   |exfighter5b    |ExFighter0x5B\n0x5C   |exfighter5c    |ExFighter0x5C\n0x5D   |exfighter5d    |ExFighter0x5D\n0x5E   |exfighter5e    |ExFighter0x5E\n0x5F   |exfighter5f    |ExFighter0x5F\n0x60   |exfighter60    |ExFighter0x60\n0x61   |exfighter61    |ExFighter0x61\n0x62   |exfighter62    |ExFighter0x62\n0x63   |exfighter63    |ExFighter0x63\n0x64   |exfighter64    |ExFighter0x64\n0x65   |exfighter65    |ExFighter0x65\n0x66   |exfighter66    |ExFighter0x66\n0x67   |exfighter67    |ExFighter0x67\n0x68   |exfighter68    |ExFighter0x68\n0x69   |exfighter69    |ExFighter0x69\n0x6A   |exfighter6a    |ExFighter0x6A\n0x6B   |exfighter6b    |ExFighter0x6B\n0x6C   |exfighter6c    |ExFighter0x6C\n0x6D   |exfighter6d    |ExFighter0x6D\n0x6E   |exfighter6e    |ExFighter0x6E\n0x6F   |exfighter6f    |ExFighter0x6F\n0x70   |exfighter70    |ExFighter0x70\n0x71   |exfighter71    |ExFighter0x71\n0x72   |exfighter72    |ExFighter0x72\n0x73   |exfighter73    |ExFighter0x73\n0x74   |exfighter74    |ExFighter0x74\n0x75   |exfighter75    |ExFighter0x75\n0x76   |exfighter76    |ExFighter0x76\n0x77   |exfighter77    |ExFighter0x77\n0x78   |exfighter78    |ExFighter0x78\n0x79   |exfighter79    |ExFighter0x79\n0x7A   |exfighter7a    |ExFighter0x7A\n0x7B   |exfighter7b    |ExFighter0x7B\n0x7C   |exfighter7c    |ExFighter0x7C\n0x7D   |exfighter7d    |ExFighter0x7D\n0x7E   |exfighter7e    |ExFighter0x7E\n0x7F   |exfighter7f    |ExFighter0x7F";
        ...
        public static void GenerateList()
        {
            ...
            if (!File.Exists(listName))
                GenerateDefaultList();
            nameList = new List<string>(File.ReadAllLines(listName));
        }
    }
    ...
    public static class StageNameGenerators
    {
        ...
        public static string FromID(int id)
        {
            foreach (string s in fileList)
                if (s.Length >= 25 && s.ToUpper().StartsWith("0X" + id.ToString("X2").ToUpper()))
                    return s.Substring(24);
        ...
        public static void GenerateList()
        {
            ...
            foreach (string s in fileList)
                if (s.Length >= 25 && s.StartsWith("0x"))
                    stageList.Add(new Stage(Convert.ToByte(s.Substring(2, 2), 16), true));
        }
    }
}
