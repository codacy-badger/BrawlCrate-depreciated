...
namespace BrawlLib.OpenGL
{
    ...
    public unsafe class TKContext : IDisposable
    {
        ...
        public static List<TKContext> BoundContexts =>
            _boundContexts == null ? _boundContexts = new List<TKContext>() : _boundContexts;
        ...
        {
            return FindOrCreate<GLDisplayList>("Line", CreateLine);
        }
        ...
        {
            return FindOrCreate<GLDisplayList>("Ring", CreateRing);
        }
        ...
        {
            return FindOrCreate<GLDisplayList>("Square", CreateSquare);
        }
        ...
        {
            return FindOrCreate<GLDisplayList>("Axes", CreateAxes);
        }
        ...
        {
            return FindOrCreate<GLDisplayList>("Cube", CreateCube);
        }
        ...
        {
            return FindOrCreate<GLDisplayList>("Circle", CreateCircle);
        }
        ...
        {
            return FindOrCreate<GLDisplayList>("Sphere", CreateSphere);
        }
