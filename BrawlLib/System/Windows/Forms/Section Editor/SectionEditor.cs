    ...
    public unsafe partial class SectionEditor : Form
    {
        ...
        private void LoadAnnotations()
        {
            ...
            if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation"))
            {
                ...
                {
                    if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).Equals("en", StringComparison.OrdinalIgnoreCase) ? "" : (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).ToLower() + '\\')) + "InternalDocumentation" + "\\Module"))
                    {
                        if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).Equals("en", StringComparison.OrdinalIgnoreCase) ? "" : (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).ToLower() + '\\')) + "InternalDocumentation" + "\\Module\\" + _section.Root.Name))
                        {
                            if(File.Exists(AppDomain.CurrentDomain.BaseDirectory + (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).Equals("en", StringComparison.OrdinalIgnoreCase) ? "" : (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).ToLower() + '\\')) + "InternalDocumentation" + "\\Module\\" + _section.Root.Name + '\\' + _section.Name + ".txt"))
                            {
        ...
        public void SaveAnnotation()
        {
            ...
            Directory.CreateDirectory(AppDomain.CurrentDomain.BaseDirectory + (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).Equals("en", StringComparison.OrdinalIgnoreCase) ? "" : (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).ToLower() + '\\')) + "InternalDocumentation");
            Directory.CreateDirectory(AppDomain.CurrentDomain.BaseDirectory + (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).Equals("en", StringComparison.OrdinalIgnoreCase) ? "" : (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).ToLower() + '\\')) + "InternalDocumentation" + "\\Module");
            Directory.CreateDirectory(AppDomain.CurrentDomain.BaseDirectory + (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).Equals("en", StringComparison.OrdinalIgnoreCase) ? "" : (System.Threading.Thread.CurrentThread.CurrentUICulture.ToString().Substring(0, 2).ToLower() + '\\')) + "InternalDocumentation" + "\\Module\\" + _section.Root.Name);
            ...
            using (var sw = new StreamWriter(Filename))
            {
                ...
                {
                    if((!annotationDescriptions[i].StartsWith("Default: 0x") || annotationDescriptions[i].Length != 19) && annotationDescriptions[i].Length > 0)
                    {
                        if(!firstLine)
                        {
                            sw.WriteLine();
