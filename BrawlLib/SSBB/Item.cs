namespace BrawlLib.SSBB
{
    public class Item
    {
        ...
        public readonly static Item[] Items = new Item[] {
            //        ID    Display Name     
			...
			new Item(0x05, "Dollar Bill [Coin mode]"),
			...
			new Item(0x4D, "Distant Planet Pellet"),
