...
namespace BrawlLib.SSBB.ResourceNodes
{
    ...
    public unsafe class REFFAnimationNode : ResourceNode
    {
        ...
        {
            get { return _isPtcl ? AnimType.Particle : AnimType.Emitter; }
        ...
        [Category("Effect Animation")]
        public ushort RandomSeed { get { return _hdr.randomSeed; } set { _random = new Random(_hdr.randomSeed = value); SignalPropertyChange(); } }
        [Category("Effect Animation")]
        public ushort FrameCount { get { return _hdr.frameLength; } set { _hdr.frameLength = value; SignalPropertyChange(); } }
        //[Category("Animation")]
