...
namespace BrawlLib.SSBB.ResourceNodes
{
    ...
    {
        public override ResourceType ResourceType => ResourceType.TBGD;
        ...
        public IEnumerable<AttributeInterpretation> GetPossibleInterpretations()
        {
            ...
            IEnumerable<AttributeInterpretation> q = from f in TBGDFormats
        ...
        private static readonly List<AttributeInterpretation> TBGDFormats = new List<AttributeInterpretation>();
