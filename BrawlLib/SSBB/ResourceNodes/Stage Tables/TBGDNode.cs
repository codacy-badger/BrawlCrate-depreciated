...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class TBGDNode : ARCEntryNode, IAttributeList
    {
        ...
        [Category("TBGD")] public int NumEntries => entries.Length / 4;
        ...
        {
            return ((TBGD*) source.Address)->_tag == TBGD.Tag ? new TBGDNode() : null;
        }
        ...
        private AttributeInterpretation GenerateDefaultInterpretation()
        {
            ...
            string filename = AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGD\\" +
            ...
            if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation"))
            {
                if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGD"))
                {
                    foreach (string path in Directory.EnumerateFiles(
                        AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGD", "*.txt"))
                    {
