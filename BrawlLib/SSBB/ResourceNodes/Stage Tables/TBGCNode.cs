...
namespace BrawlLib.SSBB.ResourceNodes
{
    ...
    {
        public override ResourceType ResourceType => ResourceType.TBGC;
        ...
        public IEnumerable<AttributeInterpretation> GetPossibleInterpretations()
        {
            ...
            IEnumerable<AttributeInterpretation> q = from f in TBGCFormats
        ...
        private static readonly List<AttributeInterpretation> TBGCFormats = new List<AttributeInterpretation>();
