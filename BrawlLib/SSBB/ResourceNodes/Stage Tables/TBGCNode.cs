...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class TBGCNode : ARCEntryNode, IAttributeList
    {
        ...
        [Category("TBGC")] public int NumEntries => entries.Length / 4;
        ...
        {
            return ((TBGC*) source.Address)->_tag == TBGC.Tag ? new TBGCNode() : null;
        }
        ...
        private AttributeInterpretation GenerateDefaultInterpretation()
        {
            ...
            string filename = AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGC\\" +
            ...
            if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation"))
            {
                if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGC"))
                {
                    foreach (string path in Directory.EnumerateFiles(
                        AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGC", "*.txt"))
                    {
