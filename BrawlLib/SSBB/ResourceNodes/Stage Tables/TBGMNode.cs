...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class TBGMNode : ARCEntryNode, IAttributeList
    {
        ...
        [Category("TBGM")] public int NumEntries => entries.Length / 4;
        ...
        {
            return ((TBGM*) source.Address)->_tag == TBGM.Tag ? new TBGMNode() : null;
        }
        ...
        private AttributeInterpretation GenerateDefaultInterpretation()
        {
            ...
            string filename = AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGM\\" +
        ...
        private static void ReadConfig()
        {
            ...
            {
                if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGM"))
                {
                    foreach (string path in Directory.EnumerateFiles(
                        AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBGM", "*.txt"))
                    {
