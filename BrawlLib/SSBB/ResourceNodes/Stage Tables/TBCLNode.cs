...
namespace BrawlLib.SSBB.ResourceNodes
{
    public unsafe class TBCLNode : ARCEntryNode, IAttributeList
    {
        ...
        [Category("TBCL")] public int NumEntries => entries.Length / 4;
        ...
        {
            return ((TBCL*) source.Address)->_tag == TBCL.Tag ? new TBCLNode() : null;
        }
        ...
        private AttributeInterpretation GenerateDefaultInterpretation()
        {
            ...
            string filename = AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBCL\\" +
            ...
            if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation"))
            {
                if (Directory.Exists(AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBCL"))
                {
                    foreach (string path in Directory.EnumerateFiles(
                        AppDomain.CurrentDomain.BaseDirectory + "InternalDocumentation" + "\\TBCL", "*.txt"))
                    {
