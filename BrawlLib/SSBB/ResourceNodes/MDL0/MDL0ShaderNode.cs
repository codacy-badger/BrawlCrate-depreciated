            ...
            *header->SwapBlock = _swapBlock;
            ...
            for (int i = 0; i < Children.Count; i++)
            {
                ...
                if (i % 2 == 0) //Even Stage
                {
                    *grp = StageGroup.Default;
                    ...
                    if (i == Children.Count - 1) //Last stage is even, odd stage isn't used
                    {
                        ...
                        grp->tref.Data = new RAS1_TRef(c._texMapID, c._texCoord, c._texEnabled, c._colorChan,
                ...
                else //Odd Stage
                {
                    ...
                    grp->tref.Data = new RAS1_TRef(p._texMapID, p._texCoord, p._texEnabled, p._colorChan, c._texMapID,
