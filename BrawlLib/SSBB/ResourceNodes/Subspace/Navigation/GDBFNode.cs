...
namespace BrawlLib.SSBB.ResourceNodes
{
    ...
    {
        internal GDBF* Header => (GDBF*) WorkingUncompressed.Address;
        public override ResourceType ResourceType => ResourceType.GDBF;

        private int _doors;
        [Category("GDBF")] public int Doors => _doors;
        ...
        {
            return ((GDBF*) source.Address)->_tag == GDBF.Tag ? new GDBFNode() : null;
        }
    }

    public unsafe class GDBFEntryNode : ResourceNode
    {
        internal GDBFEntry* Header => (GDBFEntry*) WorkingUncompressed.Address;
