...
namespace BrawlLib.SSBB.ResourceNodes
{
    ...
    public unsafe class BGMGEntryNode : ResourceNode
    {
        ...
        public string StageID { get => _stageID; set { _stageID = value; SignalPropertyChange(); } }


        private int _infoIndex;
        [Category("BGMG")]
        [DisplayName("Infoindex")]
        public int InfoIndex { get => _infoIndex; set { _infoIndex = value; SignalPropertyChange(); } }


        private int _volume;
        [Category("BGMG")]
        [DisplayName("Volume")]
        public int Volume { get => _volume; set { _volume = value; SignalPropertyChange(); } }
