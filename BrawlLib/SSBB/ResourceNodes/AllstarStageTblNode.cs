...
namespace BrawlLib.SSBB.ResourceNodes
{
    ...
    public unsafe class AllstarFighterNode : ResourceNode
    {
        ...
        public byte FighterID { get => _fighterID; set { _fighterID = value; Name = BrawlLib.BrawlCrate.FighterNameGenerators.FromID(_fighterID, BrawlLib.BrawlCrate.FighterNameGenerators.slotIDIndex, "-S"); SignalPropertyChange(); } }
