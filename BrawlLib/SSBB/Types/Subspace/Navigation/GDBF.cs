...
namespace BrawlLib.SSBBTypes
{
    ...
    public unsafe struct GDBF
    {
        public const uint Tag = 0x46424447;
        public const int Size = 0x08;
        public uint _tag;
        public bint _count;

        public GDBF(int count)
        {
            _tag = Tag;
            _count = count;
        }
   ...
   [StructLayout(LayoutKind.Sequential, Pack = 1)]
   public unsafe struct GDBFEntry
   {
       ...
       public GDBFEntry(string stageID, string trigger0, string trigger1, string trigger2, int modelIndex)
       {
           _pad0 = 1.0f;
