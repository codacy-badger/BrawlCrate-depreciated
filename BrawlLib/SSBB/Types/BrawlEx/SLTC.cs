...
namespace BrawlLib.SSBBTypes
{
    ...
    public unsafe struct SLTC
    {
        ...
        public bint _slot1;                         // 0x10
        public bint _slot2;                         // 0x14
        public bint _slot3;                         // 0x18
        public bint _slot4;                         // 0x1C
        public bint _victoryTheme;                  // 0x20 - Victory Theme
        ...
        public bint _announcerSFX;                  // 0x28 - Announcer voiceline for victory screen
        public bint _unknown0x2C;                   // 0x2C - Appears to always be 0xCCCCCCCC
