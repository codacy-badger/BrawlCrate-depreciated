...
namespace BrawlLib.Modeling
{
    public unsafe partial class Collada : Form
    {
        ...
        public IModel ImportModel(string filePath, ImportType type)
        {
            ...
            using (DecoderShell shell = DecoderShell.Import(filePath))
            {
                try
                {
                    ...
                    {
                        string name = img._path != null ? Path.GetFileNameWithoutExtension(img._path) :
        ...
        public class ImportOptions
        {
            ...
            [DisplayName("Blender FBX Bone Fix")]
            [Category("Model")]
            [Description("Removes bones added by blender fbx exports (armature and end bones).")]
